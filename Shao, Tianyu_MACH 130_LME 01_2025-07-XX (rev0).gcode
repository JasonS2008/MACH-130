...
N0030 X0.25 Y1.75 (POINT #1)
N0035 G01 X0.25 Y1.75 Z-0.050 F8.0 (FEED TO FIRST PASS DEPTH)
...
N0075 G01 X0.25 Y0.375 (POINT #9)
N0080 G01 X0.25 Y1.75 (POINT #1, BEGIN 2ND PASS)
N0081 G01 X0.25 Y1.75 Z-0.1 (FEED TO FINAL DEPTH)
...
N0120 G01 X0.25 Y0.375 (POINT #9)
N0125 G01 X0.25 Y1.75 Z-0.1 (POINT #1, CLOSE THE LOOP)
N0130 G00 G40 Z0.1 M09 (CLEAR THE Z-AXIS, COOLANT OFF, CUTTER COMP OFF)
...
N0145 G54 G90 G00 X1.5 Y1.75 (POINT E)
N0146 G43 H03 Z0.1 M08 (RAPID TO .1 ABOVE PART. COOLANT ON)
N0147 S6000 M03 (SET SPINDLE SPEED TO 6000 RPM)
N0150 G01 X1.5 Y1.75 Z-0.05 F12.0 (FEED TO FIRST PASS DEPTH)
N0155 G01 X2.75 Y1.75 (POINT F)
N0160 G01 X1.5 Y1.75 (POINT E)
N0165 G01 Z-0.1 (FEED TO SECOND PASS DEPTH)
N0170 G01 X2.75 Y1.75 (POINT F)
N0175 G01 X1.5 Y1.75 (POINT E)
N0180 G01 Z-0.15 (FEED TO THIRD PASS DEPTH)
N0185 G01 X2.75 Y1.75 (POINT F)
N0190 G01 X1.5 Y1.75 (POINT E)
N0195 G01 Z-0.2 (FEED TO FOURTH PASS DEPTH)
N0200 G01 X2.75 Y1.75 (POINT F)
N0205 G01 X1.5 Y1.75 (POINT E)
N0210 G01 Z-0.25 (FEED TO FIFTH PASS DEPTH)
N0215 G01 X2.75 Y1.75 (POINT F)
N0220 G01 X1.5 Y1.75 (POINT E)
N0225 G00 Z0.1 (CLEAR Z-AXIS)

	(PERIMETER OF SLOT: #10-#13 WITH G41)
N0230 G41 D03 X2.75 Y1.55 (TURN ON LEFT CUTTER COMP. MAKE ADJUSTING MOVT TO #10)
N0235 G01 Z-0.05 (FEED TO FIRST PASS DEPTH)
...
N0260 G01 Z-0.1 (FEED TO SECOND PASS DEPTH)
N0265 G03 X2.75 Y1.95 R0.2 (POINT #11)
N0270 G01 X1.5 Y1.95 (POINT #12)
N0275 G03 X1.5 Y1.55 R0.2 (POINT #13)
N0280 G01 X2.75 Y1.55 (POINT #10)
N0285 G01 Z-0.15 (FEED TO THIRD PASS DEPTH)
N0290 G03 X2.75 Y1.95 R0.2 (POINT #11)
N0295 G01 X1.5 Y1.95 (POINT #12)
N0300 G03 X1.5 Y1.55 R0.2 (POINT #13)
N0305 G01 X2.75 Y1.55 (POINT #10)
N0310 G01 Z-0.2 (FEED TO FOURTH PASS DEPTH)
N0315 G03 X2.75 Y1.95 R0.2 (POINT #11)
N0320 G01 X1.5 Y1.95 (POINT #12)
N0325 G03 X1.5 Y1.55 R0.2 (POINT #13)
N0330 G01 X2.75 Y1.55 (POINT #10)
N0310 G01 Z-0.25 (FEED TO FIFTH PASS DEPTH)
N0315 G03 X2.75 Y1.95 R0.2 (POINT #11)
N0320 G01 X1.5 Y1.95 (POINT #12)
N0325 G03 X1.5 Y1.55 R0.2 (POINT #13)
N0330 G01 X2.75 Y1.55 (POINT #10)
N0335 G01 Z0.1 M09 G40 (CLEAR Z-AXIS, COOLANT OFF, CUTTER COMP OFF)
...
N0435 G43 H05 Z0.1 M08 (RAPID TO .1 ABOVE PART. COOLANT ON)
N0440 G00 X0.875 Y1.125 (MOVE ABOVE POINT A)
N0445 G83 X0.875 Y1.125 Z-0.4 R0.1 Q0.25 F5.0 (START CANNED CYCLE, DRILL POINT A)
...
N0475 G43 H06 Z0.1 M08 (RAPID TO .1 ABOVE PART. COOLANT ON)
N0480 G00 X2.2 Y0.625 (MOVE ABOVE POINT C)
N0485 G83 X2.2 Y0.625 Z-0.5 R0.1 Q0.25 F5.0 (START CANNED CYCLE, DRILL POINT C)
